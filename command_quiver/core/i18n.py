...
_TRANSLATIONS: dict[Language, dict[str, str]] = {
    "it": {
        ...
        # --- Sync ---
        "sync.title": "Sincronizzazione GitHub",
        "sync.repo_owner": "Proprietario repo",
        "sync.repo_owner_placeholder": "es: tuousername",
        "sync.repo_name": "Nome repo",
        "sync.repo_name_placeholder": "es: command-quiver-sync",
        "sync.token": "Token GitHub",
        "sync.token_placeholder": "ghp_...",
        "sync.btn_test": "Testa connessione",
        "sync.btn_enable": "Attiva sync",
        "sync.btn_disable": "Disattiva sync",
        "sync.btn_sync_now": "Sincronizza ora",
        "sync.status_ok": "Sync OK",
        "sync.status_syncing": "Sync...",
        "sync.status_error": "Sync errore",
        "sync.status_disabled": "Sync off",
        "sync.test_success": "Connessione riuscita",
        "sync.test_fail": "Connessione fallita",
        "sync.saved": "Configurazione sync salvata",
        "sync.last_sync": "Ultimo sync: {time}",
        "sync.result": "Sync: {pulled} ricevute, {pushed} inviate",
        # --- Common ---
    ...
    "en": {
        ...
        "sync.repo_owner": "Repo owner",
        "sync.repo_owner_placeholder": "e.g.: yourusername",
        "sync.repo_name": "Repo name",
        "sync.repo_name_placeholder": "e.g.: command-quiver-sync",
        "sync.token": "GitHub token",
        "sync.token_placeholder": "ghp_...",
        "sync.btn_test": "Test connection",
        "sync.btn_enable": "Enable sync",
        "sync.btn_disable": "Disable sync",
        "sync.btn_sync_now": "Sync now",
        "sync.status_ok": "Sync OK",
        "sync.status_syncing": "Syncing...",
        "sync.status_error": "Sync error",
        "sync.status_disabled": "Sync off",
        "sync.test_success": "Connection successful",
        "sync.test_fail": "Connection failed",
        "sync.saved": "Sync configuration saved",
        "sync.last_sync": "Last sync: {time}",
        "sync.result": "Sync: {pulled} received, {pushed} sent",
        # --- Common ---
